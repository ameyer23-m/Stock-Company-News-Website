...
```textfile
csv creators/
|-> sales_data_creator.py  | Code to create sales data csv file
|-> stock_data_creator.py  | Code to create stock prices data csv file
|-> news_data_creator.py   | Code to create news data csv file
